...
import com.starsoft.testapp.applicationFlow.rootFlow.fourPageFlow.FourPageViewModel.Companion.testFourPageViewModel
import com.starsoft.testapp.utils.ktpViewModel


/**
 * Created by Dmitry Starkin on 28.02.2025 14:00.
 */
@Preview
@Composable
...
class FourPage : Router.ComposeScreen {
    ...
    override fun onCreate(owner: LifecycleOwner) {
        Log.d("test","FourPage ${this.hashCode()} Created owner ${owner.hashCode()} ")
        
        openParentScopes()
            .openSubScope(scopeIdentifier) {
                it.installModules(fourModule())
                Log.d("test","opened Scope $it")
            }.inject(this)
    }
