...
import com.starsoft.testhiltapp.thirdPageFlow.ThirdPageViewModel.Companion.testThirdPageViewModel


/**
 * Created by Dmitry Starkin on 06.03.2025 18:41.
 */
@Preview
@Composable
...
fun ThirdPageUi(
        ...
        data: Bundle?,
        viewModel: ThirdPageViewModel = hiltViewModel())
{
