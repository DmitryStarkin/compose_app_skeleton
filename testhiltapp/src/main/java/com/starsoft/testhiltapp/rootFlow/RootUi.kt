...
import com.starsoft.testhiltapp.rootFlow.RootUIViewModel.Companion.testRootUIViewModel
import com.starsoft.testhiltapp.secondPageFlow.SecondPage
import com.starsoft.testhiltapp.thirdPageFlow.ThirdPage


/**
 * Created by Dmitry Starkin on 06.03.2025 16:33.
 */
@Preview
@Composable
...
fun RootUi(
        ...
        viewModel: RootUIViewModel = hiltViewModel()
) {
